<!-- Vue Bits · https://vue-bits.dev · MIT · adaptado para o site (ver eslint) -->
<template>
  <div
    ref="rootRef"
...
interface DomeGalleryProps {
  ...
  maxRadius?: number;
  padFactor?: number;
  /** Limite do raio em múltiplos da altura do contêiner (1.35 no upstream). */
  ...
  grayscale?: boolean;
  /** Gira o domo sozinho (pausa ao arrastar, ampliar ou fora da viewport). */
  autoRotate?: boolean;
  /** Graus por segundo da rotação automática. */
  autoRotateSpeed?: number;
  /** Pausa a rotação automática com o mouse sobre o domo. */
...
const computeRadius = () => {
  ...
  radius = Math.min(radius, h * props.maxRadiusFactor)
